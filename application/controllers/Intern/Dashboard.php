...
<tr>
  <td style="text-align: center;" colspan="2">
    <center style="font-size: 22px; color: white; text-transform: uppercase; font-family: sans-serif;">' . $info->name . '</center>
      <center style="font-size: 15px; color: white; text-transform: uppercase;font-family: sans-serif;">' . $info->state . '</center>
      <br>
      <center style="font-size: 25px; color: white; text-transform: uppercase;font-family: sans-serif;text-decoration: underline;">' . $info->domain . '</center>
  </td>
</tr>
<tr>
